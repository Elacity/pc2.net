...
## [2.6.0](https://github.com/Elacity/pc2.net/compare/v2.5.1...v2.6.0) (2026-01-29)


### Features

* Add 'Get API Credits' link to Claude API key section ([372119d](https://github.com/Elacity/pc2.net/commit/372119d16a9069aada6bb0a9ee4eaa30adb098e1))
* add Agents section for managing AI personalities ([f61df7c](https://github.com/Elacity/pc2.net/commit/f61df7cc7be04c17d78f4ef4d26d311fd81cb0bc))
* add BNB Chain, Avalanche, Linea, Solana support to AgentKit ([6c9a81b](https://github.com/Elacity/pc2.net/commit/6c9a81bf43bd4dc43c6dbbf86dbe374ef8a6dbec))
* add BTCD token + PGP oracle price fetching ([b2eb130](https://github.com/Elacity/pc2.net/commit/b2eb130805e3894d3f4a5db1f0a094a435293dc7))
* add channel source indicators and read-only wallet access ([e9262b3](https://github.com/Elacity/pc2.net/commit/e9262b3c0c6fe2f5fd6da51a7dbd7566ce3c2fdf))
* add Clawdbot gateway integration infrastructure ([f9eaadd](https://github.com/Elacity/pc2.net/commit/f9eaadda07b6526f03953a171d2a5846aa1be3eb))
* Add delete agent button to AI Settings ([467cd70](https://github.com/Elacity/pc2.net/commit/467cd7009a7dbcde3068f4c8255d53ae836e43c0))
* Add editable memory section to Agent Editor ([a6ed41e](https://github.com/Elacity/pc2.net/commit/a6ed41e58f5e7bcaa990333197bdf2d8c5fdf08b))
* Add EID chain, Link DID button, and improve network dropdown ([8a21539](https://github.com/Elacity/pc2.net/commit/8a21539beea4b7f89dd77cc400885b50ec0e4f8b))
* add Elastos DAO Dashboard app (Phase 1 MVP) ([25fc6e2](https://github.com/Elacity/pc2.net/commit/25fc6e2a8930533ac4b063662b10d90551727925))
* add Elastos ecosystem chains + multi-RPC fallback ([16cf435](https://github.com/Elacity/pc2.net/commit/16cf435345e0a431a19fe7c1532746a2b3d058ee))
* add Elastos ecosystem chains to ConnectKit ([8d471fb](https://github.com/Elacity/pc2.net/commit/8d471fb24a51518c2079117d27b74988cf0ce9e3))
* Add Elastos Identity section for DID tethering ([d5cc348](https://github.com/Elacity/pc2.net/commit/d5cc3486ecbdd1c60c9ff5394ac06b62e2ac6f73))
* Add one-liner local quick start script ([d056c0c](https://github.com/Elacity/pc2.net/commit/d056c0c791426aa444e47ef62157bf8ab78ee877))
* add PGP chain icon + improved price fetching ([0ce1f70](https://github.com/Elacity/pc2.net/commit/0ce1f703bd5c71c89c33a77740796c300e09eda3))
* add proper Telegram connect modal instead of browser prompt ([85d2544](https://github.com/Elacity/pc2.net/commit/85d2544aaeb5557804ab442cc45e87b7c1c681ee))
* add real-time swap estimation with expected output and fees ([4804941](https://github.com/Elacity/pc2.net/commit/48049418c1685a2d4089d24709d0dc5d7b0cc86f))
* add suggestion creation form with AI assist (Phase 2B) ([4e66a97](https://github.com/Elacity/pc2.net/commit/4e66a972ecdcd1eb0ebf606a28a4b8a46eb70fd2))
* add Telegram settings modal with personality system ([5b5b952](https://github.com/Elacity/pc2.net/commit/5b5b952711f0f110f2d787c1345001456e07c609))
* add wallet integration and voting UI (Phase 2A) ([ed81863](https://github.com/Elacity/pc2.net/commit/ed81863510487fcf37d785a306e908e4a4f1c8e7))
* Agent Account architecture and ParticleWalletProvider foundation ([7d8424b](https://github.com/Elacity/pc2.net/commit/7d8424b7989180e751e2966e21111cdf708b8964))
* Agent Enhancements Phase 1.5 ([108e26c](https://github.com/Elacity/pc2.net/commit/108e26cbe14c26d7ffcda6ec955d5ff4a1890cd2))
* Agent image picker with PC2 file browser integration ([0427c94](https://github.com/Elacity/pc2.net/commit/0427c94af58dc21726309d03e86d64042b78464d))
* **agents:** add Flint - ElastOS education bot ([247af71](https://github.com/Elacity/pc2.net/commit/247af719f211b06779279948aec76fe6df20379f))
* always show BTCD token on PGP chain ([5a92236](https://github.com/Elacity/pc2.net/commit/5a922362cc3ee38009f25efebfc01507df33844a))
* complete AgentKit Phase 1.5 with UI polish and docs ([a054541](https://github.com/Elacity/pc2.net/commit/a0545411719cee02564e6ce30b879f3029c8e984))
* Complete node restoration - backup and restore all critical files ([89b7b15](https://github.com/Elacity/pc2.net/commit/89b7b15c42eaed2f3562304c7ae5cce70814911d))
* comprehensive Agent Editor as resizable window ([9495923](https://github.com/Elacity/pc2.net/commit/949592326dd8ddfad32c2435436d2e86efbedba0))
* DAO Dashboard UX improvements and window management fixes ([272f78c](https://github.com/Elacity/pc2.net/commit/272f78cd201dc1b9fa9c89ca9ccd510f24d9e9e2))
* **dao-dashboard:** list view with 12-bar voting visualization ([60253f1](https://github.com/Elacity/pc2.net/commit/60253f17adb4d2f8f17623945116274f550cbcf2))
* **dao-dashboard:** UI improvements and DID integration ([66ce19e](https://github.com/Elacity/pc2.net/commit/66ce19e55a6420bfb7df7441a72d8d1b96aa4778))
* DID tethering backend and frontend integration ([2c20ec0](https://github.com/Elacity/pc2.net/commit/2c20ec073e9e3b084ecf7a8e736ae558cb3389d8))
* Enable multi-chain wallet support in ConnectKit ([75ac5c6](https://github.com/Elacity/pc2.net/commit/75ac5c62d0228188ec73b7afddbc35699c9ebd86))
* Enhanced ready banner with clear step-by-step instructions ([349f403](https://github.com/Elacity/pc2.net/commit/349f403dfbadd9e479aaea51996ab98afbb1ed68))
* EOA multi-network support in wallet sidebar ([6d3dc93](https://github.com/Elacity/pc2.net/commit/6d3dc93abffc649c9ae10c7ec53f0691ba34d107))
* Epic branding for install script ([b215002](https://github.com/Elacity/pc2.net/commit/b21500278e41562d6edc935793108d5755f07e3f))
* expand token support per chain ([6191b3b](https://github.com/Elacity/pc2.net/commit/6191b3b4e54a6f68e021833cc68df4623c0d21fe))
* implement swap/convert between primary assets via Particle UniversalX ([f175980](https://github.com/Elacity/pc2.net/commit/f175980f438aef965726a0a5a5fa3f103712ec30))
* implement WhatsApp and Telegram channel adapters ([643581a](https://github.com/Elacity/pc2.net/commit/643581a6072e5828b5c45c50536bfd553a6ab8ae))
* improve swap UI, activity icons, and AI capabilities ([857bc3f](https://github.com/Elacity/pc2.net/commit/857bc3f558b1b3172e15dd59330cfd5feba61cd7))
* Integrate AgentKit tools into AI agent ([ecb9147](https://github.com/Elacity/pc2.net/commit/ecb9147d8090ff5a6abedd5b745b3b0ecdad2ea7))
* live countdown and pending badge for Activity tab ([42e6d74](https://github.com/Elacity/pc2.net/commit/42e6d7498bdd3c4c7598254ef6154a858ac8f4be))
* Move agent selector to AI chat panel with UX improvements ([7baa075](https://github.com/Elacity/pc2.net/commit/7baa07505497f1f81bb3c34bef03c4b1b40e6179))
* Multi-account UX improvements and UI polish ([ef1af1a](https://github.com/Elacity/pc2.net/commit/ef1af1aad964a7e48895e7cd32444007b8c6c067))
* Multi-step DID tethering with wallet address collection ([8af3352](https://github.com/Elacity/pc2.net/commit/8af3352a3f4a0e65a7d9d4cb9dce3793ddd38fcc))
* Per-agent isolated memory system (Clawdbot integration) ([55dd78e](https://github.com/Elacity/pc2.net/commit/55dd78e4e859f2113d0abe80575bb4b4568352d1))
* persist gateway config and auto-reconnect channels on startup ([edfb20b](https://github.com/Elacity/pc2.net/commit/edfb20beaf38df0d8ca7df05015483fba35503e0))
* prioritize cloud AI providers over local when API keys exist ([8c527b2](https://github.com/Elacity/pc2.net/commit/8c527b2a16702ea7a42cc6d2909d8ed9c4cacf12))
* refactor channel architecture - saved channels + agent tethering ([277a538](https://github.com/Elacity/pc2.net/commit/277a538b43b3a45d36ec0ca1dc2625d862dbf1f5))
* Reorder API Keys - Claude first, others Coming Soon ([8a0906c](https://github.com/Elacity/pc2.net/commit/8a0906c44c6deeb62a493e3a62541870c1b65d96))
* Settings UI redesign with grouped container styling ([2725780](https://github.com/Elacity/pc2.net/commit/2725780bd90371c0d714524d32abf48eb79c9653))
* UI polish - tooltips, DID modal z-index fix, startup docs ([e63e691](https://github.com/Elacity/pc2.net/commit/e63e691492871a5a1d682757e81a3936026e6d41))
* use Particle SDK for smart account balances via WebSocket ([7319aca](https://github.com/Elacity/pc2.net/commit/7319acabcafcf79c7ee842c21fda577c0dc5b2f3))
* v1 launch preparation - security hardening and documentation ([32a3705](https://github.com/Elacity/pc2.net/commit/32a3705d90e7b7311a3b1f58b85fb67363586b25))


### Bug Fixes

* Add --ignore-scripts to skip husky prepare hook ([71ab48b](https://github.com/Elacity/pc2.net/commit/71ab48bcc4ebb7d83ef77e01bfd23601f23ce284))
* Add --legacy-peer-deps and install frontend first ([95ed417](https://github.com/Elacity/pc2.net/commit/95ed4175fd38cb3621b2cfd7820d2c67ac45019f))
* add closeWindow helper for reliable window closing ([bb618d7](https://github.com/Elacity/pc2.net/commit/bb618d7fa3314008ef7bb9a934ba693712b824b0))
* add Elastos DAO Dashboard to app launcher ([1b48d36](https://github.com/Elacity/pc2.net/commit/1b48d3641c81f8c2dc2db502f659518219989f16))
* add error handling to prevent server crashes from Telegram/channel errors ([6430273](https://github.com/Elacity/pc2.net/commit/643027397f8b1c73a872f6ef8e1e97361e591d7b))
* add explicit handler for window close button ([7626b23](https://github.com/Elacity/pc2.net/commit/7626b2380a8145d4069a0b74d24b8b9ea798fbdf))
* add inline telegram input to Agent Editor + fix channel manager ([8fc0702](https://github.com/Elacity/pc2.net/commit/8fc07028d6ad805cd025c8461030cf2cf3690fd1))
* add missing message handlers for swap estimation and results ([3dc4583](https://github.com/Elacity/pc2.net/commit/3dc4583374a33c360da98a8dad8d622915342e98))
* Add npm rebuild for native modules ([6da691f](https://github.com/Elacity/pc2.net/commit/6da691f258436229fd7fee67cfbbb2aeca278b84))
* add Pino-compatible logger wrapper for Baileys ([f73f219](https://github.com/Elacity/pc2.net/commit/f73f21973336b2f2c7a5385ae287214489ed17ff))
* add providers list to /api/ai/config for agent editor ([fd996fc](https://github.com/Elacity/pc2.net/commit/fd996fc9ec84df6ba327e87951f18c31083cb478))
* add qrcode type declaration ([ebbe7fb](https://github.com/Elacity/pc2.net/commit/ebbe7fb4363fd55fce35d860f6b842f19b19c18a))
* Add qrcode type declarations ([86340a2](https://github.com/Elacity/pc2.net/commit/86340a2b870cc34bd9207234e47e9ad0df537435))
* add qrcode-terminal type declaration ([9c7a064](https://github.com/Elacity/pc2.net/commit/9c7a0646dbf56d4f47634f7cda4450d823f7c72a))
* add tool_choice to Claude provider and reinforce tool usage ([019aea3](https://github.com/Elacity/pc2.net/commit/019aea3f4c23bd12e16f37b78f225c371f1ded18))
* Add viem dependency for wallet provider ([f371daa](https://github.com/Elacity/pc2.net/commit/f371daae85a7bef662339439e3404fdc54b609f9))
* Agent creation uses POST with required workspace field ([97014ba](https://github.com/Elacity/pc2.net/commit/97014bad8befe064ebbc925c46c42a2a5b2cb3a7))
* **auth:** make particle-auth work on all deployment paths ([ed10f3f](https://github.com/Elacity/pc2.net/commit/ed10f3f7b8898234b4b3ecb9137ad807f02434ef))
* **auth:** only use Boson public URL when actually proxied ([f3fcbe9](https://github.com/Elacity/pc2.net/commit/f3fcbe9f2b5843ecf47a11a61973cdec65b960ae))
* button styling + show bot username in channel manager ([49a7f15](https://github.com/Elacity/pc2.net/commit/49a7f15a9ca15856e88d582407e8a40c1c8f47bb))
* close button not working on transaction confirm modal ([3eae0d9](https://github.com/Elacity/pc2.net/commit/3eae0d956397e9b174e529db3fbdacd767b4f8ac))
* convert markdown headers to bold for Telegram ([aac0935](https://github.com/Elacity/pc2.net/commit/aac0935f8d7e4a404ef80c0a189f3ba4aa74917e))
* convert markdown horizontal rules for Telegram ([9287c22](https://github.com/Elacity/pc2.net/commit/9287c22f1f5b8809103ba458a4b64da4f0108b7f))
* correct PGP oracle function selector for PGA/BTCD prices ([10efa75](https://github.com/Elacity/pc2.net/commit/10efa758eed7f46c890b5947fff19175d6834ca3))
* Custom SOUL.md always visible as extension to personality ([16908b2](https://github.com/Elacity/pc2.net/commit/16908b2b02a74361d3f615399dd4f194da784b3a))
* **db:** remove buggy FTS5 content reference that breaks fresh installs ([c2161bf](https://github.com/Elacity/pc2.net/commit/c2161bf137315a2bed3b7883aaf8c32b62475a1e))
* **did:** use x-forwarded-host for DID callback URL behind proxy ([4f6f613](https://github.com/Elacity/pc2.net/commit/4f6f6139b6cab860356dd72d429446223a0953a5))
* display bot username in channel manager and agent editor ([cb38d90](https://github.com/Elacity/pc2.net/commit/cb38d90549dc73726bd2f5976fd394f647c68699))
* enable WhatsApp self-chat mode and stop reconnect loop ([1429115](https://github.com/Elacity/pc2.net/commit/142911569da26ed0cf84b35bf4cad86784175333))
* force Claude to use tools with tool_choice: any ([513adae](https://github.com/Elacity/pc2.net/commit/513adae596299a72a7aeb8ef3b8c10d3550bc6ce))
* **gateway:** use x-forwarded-host for correct URL generation via proxy ([070b19c](https://github.com/Elacity/pc2.net/commit/070b19c2a1473589c78126bbe5a1eff5076d759b))
* group Elastos chains together in dropdown order ([1256a9e](https://github.com/Elacity/pc2.net/commit/1256a9ef5acfe3db80f5183acb6bc1eff95521b8))
* improve agent activity UX and EOA wallet address handling ([4f28924](https://github.com/Elacity/pc2.net/commit/4f28924e4c7bc3befc99a7726f7c88be10ead53e))
* improve button styling in agent modals ([03afa2f](https://github.com/Elacity/pc2.net/commit/03afa2f329e45145e5343a8c335d8be3d2f9b3e3))
* initialize ChannelBridge to connect AI to messaging channels ([cc66a2f](https://github.com/Elacity/pc2.net/commit/cc66a2f818a8669ffdf998cd5e1446c84fedede1))
* inject user's wallet addresses into AI system prompt ([a5fd919](https://github.com/Elacity/pc2.net/commit/a5fd919c71153b1702cd1383dacd9617024cd769))
* inject wallet context into streaming AI path ([e57b282](https://github.com/Elacity/pc2.net/commit/e57b282b47163500f1925a5ae67ff0e769be05d2))
* Install from root to enable workspace linking ([389680a](https://github.com/Elacity/pc2.net/commit/389680afbbb6519d498a38c08bbc05449e6daf84))
* Install frontend dependencies (src/gui) before build ([5d59e37](https://github.com/Elacity/pc2.net/commit/5d59e376b6f78efd878b341cb33cf9e46cefb479))
* **install:** show public IP instead of localhost on VPS ([20c3445](https://github.com/Elacity/pc2.net/commit/20c3445fa799dd136cc1da4b21a8d6c97943b92a))
* Link DID button now opens settings, fix Bitcoin icon URL ([f1cae61](https://github.com/Elacity/pc2.net/commit/f1cae618f82b5cec4311e9ea90ed4ce7525c9426))
* load owner wallet from nodeConfig for ChannelBridge ([086a633](https://github.com/Elacity/pc2.net/commit/086a633c7661754c3461746b744a92cf2798e98d))
* pass owner wallet to ChannelBridge for API key lookup ([169e287](https://github.com/Elacity/pc2.net/commit/169e2870881cd28e441fc735fba48df009d60902))
* persist gateway config and auto-reconnect channels on startup ([1990366](https://github.com/Elacity/pc2.net/commit/1990366b7b0739169dc23d05fc0d76ccab1c7983))
* persist savedChannels and agents in gateway config file ([4ca38ba](https://github.com/Elacity/pc2.net/commit/4ca38ba823ddb42471c418a9f687e73d2b700ea2))
* prevent duplicate click handlers with .off() before .on() ([e10674d](https://github.com/Elacity/pc2.net/commit/e10674dad21b0b6281410ed0061fbb7c6167aa9c))
* render markdown properly in Telegram messages ([d9a6d7e](https://github.com/Elacity/pc2.net/commit/d9a6d7e4ac0fe82f782cd5efcde193bf926a56b2))
* Replace browser confirm() with PC2 native UIAlert dialogs ([97ee6f4](https://github.com/Elacity/pc2.net/commit/97ee6f43e01edecc1875f88b95492f47b6cb45a4))
* route Telegram messages to correct AI provider ([0b93553](https://github.com/Elacity/pc2.net/commit/0b935532656093a867bdf66b4941bd20aa518868))
* save bot username when connecting Telegram ([69fe832](https://github.com/Elacity/pc2.net/commit/69fe83213b25575d56575ba26bdea42c1a47b7c6))
* **security:** apply safe npm vulnerability fixes ([9a8ac53](https://github.com/Elacity/pc2.net/commit/9a8ac538733524735d70607a485a242e0cb0af16))
* **setup:** clipboard copy fallback for HTTP in setup wizard ([8d03298](https://github.com/Elacity/pc2.net/commit/8d03298b347b103d1f6e1326c35f48901e3053f7))
* Show build errors instead of hiding them ([3e93658](https://github.com/Elacity/pc2.net/commit/3e93658d76ae8d2b99fd56242c369c814770a9b3))
* show PGA token icon in wallet sidebar ([541237b](https://github.com/Elacity/pc2.net/commit/541237b4586df17cc15c9fffc0bcbf829ddb42a2))
* store WhatsApp QR code for API retrieval, set status to 'connecting' until QR scanned ([a161378](https://github.com/Elacity/pc2.net/commit/a161378b247651e18c237335a6b89b617caf232a))
* TypeScript errors in memory tool ([65a6955](https://github.com/Elacity/pc2.net/commit/65a69554e535beb9e127bbc0112be01fc7037f53))
* UI spacing improvements ([879e114](https://github.com/Elacity/pc2.net/commit/879e1140519f4ab0abc1483807e8d3f0aca8976f))
* **ui:** add missing PGP chain icon to tokens folder ([f366469](https://github.com/Elacity/pc2.net/commit/f3664693c774d2c4ece783a80149c09738f12623))
* **ui:** clipboard copy fallback for HTTP contexts ([4ea4e65](https://github.com/Elacity/pc2.net/commit/4ea4e65cba49170e78f9740399f5151efad2c29c))
* use agent's SOUL.md and respect permissions in ChannelBridge ([5f90c9c](https://github.com/Elacity/pc2.net/commit/5f90c9cb774505143a61d812e94f4ad80d92aeb8))
* use numeric chat ID for Telegram replies instead of username ([7382148](https://github.com/Elacity/pc2.net/commit/738214857c0019bc6b69004f260cb045f54b92cc))
* Use nvm for Node.js install (no admin required) ([3a08b39](https://github.com/Elacity/pc2.net/commit/3a08b39f26114e75d2b657e9a826947fa5a9724a))
* use qrcode library to generate proper QR code image for browser display ([5e5c389](https://github.com/Elacity/pc2.net/commit/5e5c389860ef9a1b691f21e649f648883854d02a))
