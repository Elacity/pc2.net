 ...
 */
export async function createBackup(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
 ...
 * GET /api/backups
 */
export async function listBackups(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
 ...
 */
export async function deleteBackup(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    const filename = req.params.filename;
 ...
 */
export async function restoreBackup(req: AuthenticatedRequest & { file?: Express.Multer.File }, res: Response): Promise<void> {
  try {
