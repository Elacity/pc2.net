 ...
 */
export function handleTerminalStats(req, res) {
    if (!req.user) {
 ...
 */
export function handleTerminalAdminStats(req, res) {
    if (!req.user) {
        res.status(401).json({ error: 'Unauthorized' });
        return;
    }
 ...
 */
export function handleDestroyAllTerminals(req, res) {
    if (!req.user) {
        res.status(401).json({ error: 'Unauthorized' });
        return;
    }
 ...
 */
export function handleTerminalStatus(req, res) {
    try {
