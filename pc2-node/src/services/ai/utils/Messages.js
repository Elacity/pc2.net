 ...
 */
export const normalizeSingleMessage = (message, params = {}) => {
 ...
 */
export const normalizeMessages = (messages, params = {}) => {
    const normalized = [];
 ...
 */
export const extractAndRemoveSystemMessages = (messages) => {
 ...
 */
export const extractText = (messages) => {
