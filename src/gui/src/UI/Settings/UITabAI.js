...
export default {
    ...
    html: () => {
        return `
            ...
            <div class="ai-section">
                ...
                <div class="ai-group">
                    <div class="ai-group-row"><div class="ai-card-row"><span class="ai-card-label">Default</span><select id="ai-provider-select" class="ai-select"><option value="ollama">Ollama</option><option value="claude">Claude</option></select></div></div>
                </div>
            </div>
            ...
            <div class="ai-section">
                ...
                <div class="ai-group">
                    <div class="ai-group-row ai-key-card" data-provider="claude"><div class="ai-card-row"><div><span class="ai-card-label">Claude</span><span class="ai-key-badge" id="ai-claude-badge" style="display: none; font-size: 9px; padding: 1px 4px; background: #10b981; color: white; border-radius: 2px; margin-left: 4px;">Active</span><div id="ai-claude-key-display" style="font-size: 10px; color: #666; font-family: monospace; margin-top: 2px;"><span class="ai-key-status">Not configured</span></div><a href="https://platform.claude.com/settings/billing" target="_blank" style="font-size: 10px; color: #3b82f6; text-decoration: none; margin-top: 4px; display: inline-block;">Get API Credits →</a></div><div style="display: flex; gap: 4px;"><button class="button ai-btn ai-key-add-btn" id="ai-claude-add-btn" style="background: #3b82f6; color: white;">Add</button><button class="button ai-btn ai-key-update-btn" id="ai-claude-update-btn" style="display: none;">Edit</button><button class="button ai-btn ai-key-delete-btn" id="ai-claude-delete-btn" style="display: none; background: #dc2626; color: white;">×</button></div></div></div>
                    <div class="ai-group-row ai-key-card" data-provider="openai" style="opacity: 0.5;"><div class="ai-card-row"><div><span class="ai-card-label">OpenAI</span><div style="font-size: 10px; color: #999; margin-top: 2px;">Coming Soon</div></div><div><span style="font-size: 11px; color: #999; padding: 4px 10px;">Coming Soon</span></div></div></div>
                    <div class="ai-group-row ai-key-card" data-provider="gemini" style="opacity: 0.5;"><div class="ai-card-row"><div><span class="ai-card-label">Gemini</span><div style="font-size: 10px; color: #999; margin-top: 2px;">Coming Soon</div></div><div><span style="font-size: 11px; color: #999; padding: 4px 10px;">Coming Soon</span></div></div></div>
                    <div class="ai-group-row ai-key-card" data-provider="xai" style="opacity: 0.5;"><div class="ai-card-row"><div><span class="ai-card-label">xAI</span><div style="font-size: 10px; color: #999; margin-top: 2px;">Coming Soon</div></div><div><span style="font-size: 11px; color: #999; padding: 4px 10px;">Coming Soon</span></div></div></div>
                </div>
            </div>
            ...
            <div class="ai-section" style="margin-top: 20px; border-top: 1px solid #e5e5e5; padding-top: 16px;">
                <div class="ai-section-title" style="display: flex; align-items: center; justify-content: space-between;">
                    ...
                    <button class="button ai-btn" id="manage-channels-btn" style="font-size: 11px; padding: 4px 10px;">
                        Manage
                    </button>
                </div>
                <div class="ai-group" id="channels-summary">
                    <div class="ai-group-row" style="padding: 12px;">
                        <div style="display: flex; align-items: center; gap: 16px; flex-wrap: wrap;">
                            <!-- Telegram Status -->
                            <div class="channel-summary-item" data-channel="telegram" style="display: flex; align-items: center; gap: 6px;">
                                ...
                                <span class="channel-count" style="font-size: 11px; color: #666;">0 bots</span>
                            </div>
                            <!-- WhatsApp Status -->
                            <div class="channel-summary-item" data-channel="whatsapp" style="display: flex; align-items: center; gap: 6px; opacity: 0.5;">
                                ...
                                <span style="font-size: 11px; color: #999;">Soon</span>
                            </div>
                            <!-- Discord Status -->
                            <div class="channel-summary-item" data-channel="discord" style="display: flex; align-items: center; gap: 6px; opacity: 0.5;">
    ...
    init: async function($el_window) {
        ...
        // Manage Channels button handler
        $el_window.find('#manage-channels-btn').off('click').on('click', async function() {
            const { default: UIChannelManager } = await import('../Channels/UIChannelManager.js');
            UIChannelManager({
                onUpdate: async () => {
                    await loadAgents();
                }
        ...
        // Channel icons for reuse
        const channelIcons = {
            telegram: `<svg width="12" height="12" viewBox="0 0 24 24" fill="#0088cc"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>`,
            whatsapp: `<svg width="12" height="12" viewBox="0 0 24 24" fill="#25D366"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/></svg>`,
            discord: `<svg width="12" height="12" viewBox="0 0 24 24" fill="#5865F2"><path d="M20.317 4.3698a19.7913 19.7913 0 00-4.8851-1.5152.0741.0741 0 00-.0785.0371c-.211.3753-.4447.8648-.6083 1.2495-1.8447-.2762-3.68-.2762-5.4868 0-.1636-.3933-.4058-.8742-.6177-1.2495a.077.077 0 00-.0785-.037z"/></svg>`,
        };
        
        // Load saved channels and update summary
        async function loadSavedChannels() {
            try {
                const response = await fetch(`${getAPIOrigin()}/api/gateway/saved-channels`, {
                ...
                if (data.success && data.data) {
                    ...
                    const telegramCount = channels.filter(c => c.type === 'telegram').length;
                    
                    // Update summary
                    $el_window.find('.channel-summary-item[data-channel="telegram"] .channel-count')
                        .text(telegramCount === 1 ? '1 bot' : `${telegramCount} bots`);
                    
                    return channels;
                }
                return [];
            } catch (e) {
                console.warn('[AI Settings] Could not load saved channels:', e);
                return [];
            }
        }
        ...
        async function loadAgents() {
            try {
                const [agentsResponse, savedChannels] = await Promise.all([
                    fetch(`${getAPIOrigin()}/api/gateway/agents`, {
                        headers: { 'Authorization': `Bearer ${getAuthToken()}` }
                    }),
                    loadSavedChannels()
                ]);
                ...
                if (data.success && data.data) {
                    ...
                    const html = agents.map((agent, index) => {
                        ...
                        const tethered = (agent.tetheredChannels || [])
                            .map(id => savedChannels.find(c => c.id === id))
                            .filter(Boolean);
                                ...
                                <div class="ai-card-row">
                                    <div style="display: flex; align-items: center; gap: 10px; flex: 1;">
                                        ...
                                        <div style="flex: 1;">
                                            ...
                                            ${channelBadges ? `<div class="agent-channels" style="margin-top: 4px;">${channelBadges}</div>` : '<div style="font-size: 9px; color: #999; margin-top: 4px;">No channels tethered</div>'}
                                        </div>
                                    </div>
                                    <div style="display: flex; gap: 4px;">
        ...
        // Load agents and channels (non-blocking)
        loadAgents().catch(() => {});
    },
