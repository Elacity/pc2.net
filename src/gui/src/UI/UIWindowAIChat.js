                ...
                <div class="ai-window-panel">
                    ...
                    <div class="ai-chat-input-container">
                        ...
                        <div class="ai-chat-input-actions">
                            <button class="ai-activity-btn" title="View Activity">
                            ...
                            <button class="ai-voice-btn" title="Voice input">
                            ...
                            <div class="ai-agent-selector-wrapper" style="position: relative;">
                                <button class="ai-agent-btn" title="Select Agent">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
