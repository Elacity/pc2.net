...
class WalletService {
    ...
    _getStablecoinAddresses(chainId) {
        const stablecoins = {
            // Elastos Smart Chain (ESC - chainId 20)
            20: [
            ...
            1: [
                ...
                { symbol: 'DAI', name: 'Dai', address: '0x6B175474E89094C44Da98b954EescdeCB5badC0a', decimals: 18 },
            ],
            // Base (chainId 8453)
            8453: [
            ...
            43114: [
                ...
                { symbol: 'DAI.e', name: 'Dai', address: '0xd586E7F844cEa2F87f50152665BCbc2C279D8d70', decimals: 18 },
            ],
        };
