...
`}}),u,B,C=e({"src/components/button/index.tsx"(){k(),f(),j(),u=({children:t,style:n,loading:i=!1,disabled:s=!1,color:g="primary",roundedIcon:b,onClick:c,icon:d,...x})=>r.jsxs(v,{style:n,onClick:y=>{!s&&!i&&c&&c(y)},$loading:!!i,$disabled:s,$color:g,...x,children:[i&&r.jsx(m,{style:{width:"20px",marginRight:"6px"}}),r.jsxs(w,{gap:6,children:[d&&r.jsx(h,{$rounded:b,children:d}),t]})]}),B=u}});export{B as b,C as i};
