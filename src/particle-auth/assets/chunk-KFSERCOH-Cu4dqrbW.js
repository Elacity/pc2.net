import{i as $,b as L}from"./chunk-G4I34CN4-BoY9Bihp.js";import{_ as s,n as t,r as f,W as a,v as n,w as N}from"./index-DBpA8IMB.js";var h,C,W=s({"src/assets/icons/CopyIcon2.tsx"(){h=({...e})=>t.jsxs("svg",{"aria-hidden":"true",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:[t.jsx("path",{className:"bg",d:"M14 9.5V7C14 5.89543 13.1046 5 12 5H7C5.89543 5 5 5.89543 5 7V12C5 13.1046 5.89543 14 7 14H9.5",strokeWidth:"1.4"}),t.jsx("rect",{className:"bg",x:"10",y:"10",width:"9",height:"9",rx:"2",strokeWidth:"1.4"}),t.jsx("path",{d:"M1 3L3 5L7 1",strokeWidth:"1.4",strokeLinecap:"round",strokeLinejoin:"round",stroke:"#ffffff"})]}),C=h}}),v,b,c,E=s({"src/components/copyToClipboard/CopyToClipboardIcon.tsx"(){W(),v=n(N.div)`
  ...
  ${e=>e.$clipboard?a`
        ...
        `}
`,b=({copied:e,small:r})=>t.jsx(v,{$clipboard:e,children:t.jsx(C,{style:{transform:r?"scale(1)":"translateX(3px) scale(1.5)",opacity:r||e?1:.6}})}),c=b}}),g,j,S=s({"src/components/copyToClipboard/styles.ts"(){g=n.div`
  transition: all 220ms cubic-bezier(0.175, 0.885, 0.32, 1.1);
  cursor: pointer;
  display: inline-flex;
  align-items: center;
