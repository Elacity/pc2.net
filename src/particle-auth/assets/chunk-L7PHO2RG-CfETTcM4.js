...
`,ae=j(K.div)`
  ...
  &:after {
    ...
    animation: ${Xt} 1000ms linear infinite both;
    ${r=>r.$failed&&Z`
        animation: none;
      `}
  }
...
`}});function $t({value:r,image:o,imageBackground:i,ecl:n="M",imagePosition:t="center",failed:e,failedCallback:s}){const a=o;return S.jsxs(ie,{children:[e&&S.jsx(le,{children:S.jsx(we,{"aria-label":"Retry",initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.8},whileTap:{scale:.9},transition:{duration:.1},onClick:s,children:S.jsx(ye,{children:S.jsx(pe,{})})})}),S.jsxs(se,{children:[o&&S.jsx(ue,{children:S.jsx(ce,{$wcLogo:t!=="center",style:{background:t==="center"?i:void 0},children:a})}),S.jsx(be,{initial:!1,children:r?S.jsx(K.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,position:"absolute",inset:[0,0]},transition:{duration:.2},children:S.jsx(Qe,{uri:r,size:288,ecl:n,clearArea:!!(t==="center"&&o)})},r):S.jsxs(ae,{initial:{opacity:.2},animate:{opacity:.2},exit:{opacity:0,position:"absolute",inset:[0,0]},transition:{duration:.2},$failed:e,children:[S.jsx("span",{}),S.jsx("span",{}),S.jsx("span",{}),S.jsx("div",{})]})})]})]})}var Ge,$e=Et({"src/components/CustomQRCode/index.tsx"(){ge(),me(),Ye(),Oe(),$t.displayName="CustomQRCode",Ge=$t}});export{Ge as C,$e as i};
